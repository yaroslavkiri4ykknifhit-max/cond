    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px]">
                ...
                <!-- Photo 8 (Wide) -->
                <div class="bg-slate-200 rounded-2xl flex items-center justify-center overflow-hidden relative group shadow-sm hover:shadow-xl md:col-span-2 cursor-pointer" data-aos="fade-up" data-aos-delay="400">
